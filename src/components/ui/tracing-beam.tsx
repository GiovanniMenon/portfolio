...
export const TracingBeam = ({
  ...
  const y2 = useSpring(
    useTransform(scrollYProgress, [0, 1], [0, svgHeight + 1900]),
    {
      stiffness: 100,
      damping: 10,
    },
  ...
  return (
    <motion.div
      ref={ref}
      className={cn("relative mx-auto max-w-[1600px] h-full", className)}
    >
      <div className="absolute -left-20 lg:-left-5 invisible md:visible">
        <motion.div
          transition={{
            duration: 0.2,
            delay: 0.5,
        ...
        <svg
          ...
          width="20"
          height="1900" // Set the SVG height
